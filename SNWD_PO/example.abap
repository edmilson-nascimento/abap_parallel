...
CLASS lcl_po_processor DEFINITION.
  PUBLIC SECTION.
    TYPES: BEGIN OF ty_po_header,
             ...
             buyer_guid    TYPE snwd_po-buyer_guid,
    ...
    TYPES: BEGIN OF ty_po_item,
             ...
             quantity     TYPE snwd_po_i-quantity,
...
CLASS lcl_main DEFINITION.
  ...
  PRIVATE SECTION.
    ...
    CLASS-METHODS load_po_data
      IMPORTING ir_po_id      TYPE range_t_ebeln
                ir_currency   TYPE range_t_waers
  ...
  METHOD create_log_message.
    ...
    LOOP AT iv_items INTO DATA(ls_item) TO 5.
      message_list->add(
        ...
        id_msgid = '>0'
        id_msgno = '000'
        id_msgv1 = |  Item { ls_item-po_item_pos }: Qty { ls_item-quantity }, Amount { ls_item-gross_amount }|
      ).
    ENDLOOP.
...
CLASS lcl_main IMPLEMENTATION.
  METHOD start.
    ...
    gt_po_list = load_po_data( ir_po_id    = s_po_id[]
                               ir_currency = s_curr[] ).
...
SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE TEXT-001.
  SELECT-OPTIONS: s_po_id FOR snwd_po-po_id,
                  s_curr  FOR snwd_po-currency_code.
